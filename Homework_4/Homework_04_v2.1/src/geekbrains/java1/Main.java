...
public class Main {
    ...
    public static void humanTurn() {
        ...
        int column;
        do {
            System.out.println("Введите координаты хода в формате *номер строки* и *номер колонки*");
...
//        }
    ...
    public static boolean checkWin(String symb) {
        /**
         *   Вариант 1 - всегда побеждает человек в 1 ход
         */
        //проверка диагоналей
//        for (int i = 0; i < SIZE; i++) {
...
//        //   проверка столбцов
//        for (int i = 0; i < SIZE; i++) {
//            if (map[i][j + 1].equals(symb))
//                return true;
//        }//
//        //проверка строк
//        for (int j = 0; j < SIZE; j++) {
//            if (map[i + 1][j].equals(symb))
//                return true;
//        }
//        return false;
//    }
                /**
                 * Вариант 2 - всегда побеждает человек в 1 ход
                 */
        for (int i = 0; i < SIZE; i++) {
            for (int j = 0; i < SIZE; j++) {
        ...
        return false;
                ...
                /**
                 *   Вариант 3 - не работает вообще
                 */
//                    for (int i = 0; i < SIZE; i++) {
//                        for (int j = 0; i < SIZE; j++) {
//                    if (map[i][j].equals(symb) || map[i + 1][j + 1].equals(symb) || map[i ][j + 1] .equals(symb) || map[i + 1][j].equals(symb))
//                            return true;
//                        }
//                    }
//                return false;
...
//    }
        ...
        /**
         * Вариант 5 - не работает вообще
          */

//        for (int i = 0; i < SIZE; i++) {
//            for (int j = 0; i < SIZE; j++) {
//                               if (map[i][j].equals(symb) || map[i][j + 1].equals(symb) || map[i + 1][j].equals(symb))
//                return true;
//            }
//        }
//                return false;
